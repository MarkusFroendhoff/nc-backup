...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "api_token": "API-Token (Nextcloud-App)",
        "api_token_hint": "Nur für die Nextcloud-App. Token erzeugen, in Nextcloud unter <b>Einstellungen → NC Backup</b> eintragen. Wiederherstellung bleibt in dieser Web-GUI.",
        "api_token_generate": "Neues API-Token erzeugen (altes wird ungültig)",
        "api_token_set": "gesetzt",
        "api_token_missing": "kein Token – bitte erzeugen",
        "api_token_status": "Status: {status}",
        "ok_api_token": "Neues API-Token (nur diesmal sichtbar – jetzt in Nextcloud unter Einstellungen eintragen):\n{token}",
        "schedule": "Zeitplan",
    ...
    "en": {
        ...
        "api_token": "API token (Nextcloud app)",
        "api_token_hint": "Only for the Nextcloud app. Generate a token, then paste it in Nextcloud under <b>Settings → NC Backup</b>. Restore stays in this web UI.",
        "api_token_generate": "Generate a new API token (the old one stops working)",
        "api_token_set": "set",
        "api_token_missing": "no token – please generate one",
        "api_token_status": "Status: {status}",
        "ok_api_token": "New API token (shown only this once – paste it in Nextcloud settings now):\n{token}",
        "schedule": "Schedule",
